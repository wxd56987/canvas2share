...
var CanvasDrawer = /** @class */function () {
    ...
    CanvasDrawer.prototype.arc = function (x, y, radius, options) {
        ...
        var _a = options.sAngle,
            sAngle = _a === void 0 ? 0 : _a,
            _b = options.eAngle,
            eAngle = _b === void 0 ? 2 * Math.PI : _b,
            _c = options.ccw,
            ccw = _c === void 0 ? false : _c,
            color = options.color;
    ...
    CanvasDrawer.prototype.fillText = function (text, x, y, fontOptions, width, rowCount) {
        ...
        var _a = fontOptions.split(" "),
            _b = _a[0],
            fontSize = _b === void 0 ? 20 : _b,
            _c = _a[1],
            color = _c === void 0 ? "#000" : _c,
            _d = _a[2],
            lineHeight = _d === void 0 ? 1 : _d,
            _e = _a[3],
            fontStyle = _e === void 0 ? "normal" : _e,
            _f = _a[4],
        ...
        this.ctx.restore();
        // 如果文字不足一行，那么返回该行宽度
        var rowWidth = rows.length === 1 ? this.ctx.measureText(rows[0]).width / this.ratio : width;
        return {
            width: rowWidth,
            x: x,
